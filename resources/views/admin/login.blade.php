...
<head>
    ...
    <title>سامانه مدیریت خدمات رفاهی</title>
                        ...
                        <div class="col-lg-7">
                            <div class="p-5">
                                <div class="text-center">
                                    ...
                                    <h1 class="h4 text-gray-900 mb-2">سامانه مدیریت خدمات رفاهی</h1>
                                    <h4 class="small text-gray-900 mb-4">خوش آمدید</h4>
                                </div>
                                <form class="user" method="post" action="{{ route('loginAction') }}" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
