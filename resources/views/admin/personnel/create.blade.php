...
<form class="well form-horizontal" method="post" action="{{ route('personnel.store') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <div class="row" >
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control form-control-sm" name="nationalCode" value="">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group col-md-4">
                <div class="row" >
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control form-control-sm" name="identificationNumber" value="">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group col-md-4">
                <div class="row" >
                    ...
                    <div class="input-group input-group-sm col-md-8">
                        ...
                        <input type="text" class="form-control" name="phone" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                    </div>
            ...
            <div class="form-group col-md-4">
                <div class="row" >
                    ...
                    <div class="input-group input-group-sm col-md-8">
                        ...
                        <input type="text" class="form-control" name="mobile" aria-label="Small" aria-describedby="inputGroup-sizing-sm" style="direction: ltr !important" placeholder="09*********">
                    </div>
                </div>
            </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <div class="row" >
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control form-control-sm" name="personnelNumber" value="">
                    </div>
                </div>
            </div>
