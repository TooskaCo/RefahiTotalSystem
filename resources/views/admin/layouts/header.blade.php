        ...
        <ul class="navbar-nav" style="margin-left:0 !important;margin-right:60% !important">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"> کاربر   {{ Session::get('userFullName') }}</span>
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ route('logoutAction') }}" ><!--data-toggle="modal" data-target="#logoutModal"-->
